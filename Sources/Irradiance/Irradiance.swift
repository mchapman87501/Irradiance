...
// https://www2.jpl.nasa.gov/adv_tech/photovol/2016CTR/SERI%20-%20Solar%20Spec%20for%20Dir%20&%20Dif%20Irrad%20on%20Planes_1984%20.pdf
...
public struct Irradiance {
    ...
    struct IrradianceCalculator {
        ...
        fileprivate func calc(_ i: Int) -> IrradianceRecord {
            ...
            // Bird, R. E., "A Simple Spectral Model for Direct Normal and Diffuse Horizontal Irradiance,". Solar Energy, Voi. 32, 1984, pp. 461-471.
